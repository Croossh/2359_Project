...
- **박우찬: 팀장/프론트엔드 담당**<br>
기획 단계: 구체적인 설계, 와이어프레임 작성 및 팀원간 의견 조율<br>
개발 단계: 와이어프레임 기반으로 마이페이지 구현 담당<br>
수정 단계: 스크럼 및 회의 진행, 팀 구체적인 목표 설계, 발표 진행<br>

- **김혜민: 백엔드 담당**<br>
기획 단계: 기술스택 선정, 서버구조 기획, 전체적인 api 설계, DB 선택 및 구조화<br>
개발 단계:  사용자 스키마 및 api 구현, docker를 이용한 ec2 배포 구현<br>
수정 단계: 피드백 반영해서 백엔드 설계 수정, 에러 핸들러 구현<br>

- **정지헌: 백엔드 담당**<br>
기획 단계: 기술스택 선정, 서버구조 기획, 전체적인 api 설계, DB 선택 및 구조화<br>
개발 단계:  DB 생성 및 연결, 컨텐츠, 질문 스키마 및 api 구현 <br>
수정 단계:  피드백 반영해서 백엔드 설계 수정, DB 데이터 관리<br>

- **정호진: 프론트엔드 담당**<br>
기획 단계: 아이디어 도출 및 FE work flow 및 와이어프레임 작성<br>
개발 단계: work flow 및 와이어 프레임 기준으로 작성 페이지 CRUD 구현<br>
수정 단계: 피드백 및 오류 수정해서 작성 페이지 수정<br>

- **홍화낙: 프론트엔드 담당**<br>
기획 단계:와이어프레임 작성,아이디어 공유<br>
개발 단계: 와이어프레임을 기반으로 홈페이지 로그인,회원가입,회원정보수정 페이지 담당<br>
수정 단계: 피드백 반영 및 UI개선<br>

- **설지윤: 프론트엔드 담당**
기획 단계: 와이어프레임 작성<br>
개발 단계:  와이어프레임을 기반으로 캘린더, 모달, 홈페이지 담당<br>
수정 단계: 피드백 반영하여 UI개선<br>
